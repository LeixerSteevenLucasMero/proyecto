...
import kotlinx.android.synthetic.main.activity_my_rentals.*
...
class MyRentalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            tv_my_rental.setText(Html.fromHtml(message,Html.FROM_HTML_MODE_LEGACY));
        } else {
            tv_my_rental.setText(Html.fromHtml(message));
        }
